...
# multi_modal_retrival_pipeline documentation build
...
from multi_modal_retrival_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "multi_modal_retrival_pipeline"
author = "Kedro"
...
htmlhelp_basename = "multi_modal_retrival_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "multi_modal_retrival_pipeline.tex",
        "multi_modal_retrival_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "multi_modal_retrival_pipeline",
        "Project multi_modal_retrival_pipeline codebase.",
        "Data-Science",
    )
]
